...
public class SaveObject {
	public static void main(String[] args) {
		...
		try {
			//Create Objects
			Instructor instructor = new Instructor("Abhilash", "Dash", "abhilash@gmail.com");
			InstructorDetail instDetail = new InstructorDetail("http://www.youtube.com/Abhi", "Gardening");
